...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("𝗧𝗵𝗮𝘁𝘀 𝗡𝗼𝘁 𝗙𝗼𝗿 𝗬𝗼𝘂! 𝗦𝗲𝗮𝗿𝗰𝗵 𝗬𝗼𝘂𝗿𝘀𝗲𝗹𝗳 𝗗𝘂𝗱𝗲", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
    ...
    if not search:
        await query.answer("𝗣𝗹𝗲𝗮𝘀𝗲 𝗦𝗲𝗮𝗿𝗰𝗵 𝗔𝗴𝗮𝗶𝗻! 𝗧𝗵𝗶𝘀 𝗶𝘀 𝗠𝘆 𝗼𝗹𝗱 𝗠𝗲𝘀𝘀𝗮𝗴𝗲 𝗯𝗿𝗼", show_alert=True)
        return
...
async def advantage_spoll_choker(bot, query, reply, search):
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝗖𝗵𝗮𝗻𝗻𝗲𝗹', url='https://t.me/+u-ldGW74d5JiYjE1'),
            InlineKeyboardButton('𝗚𝗿𝗼𝘂𝗽', url='https://t.me/+tDg3C_j8BM40YjA1')
            ],[
        ...
        await query.answer('𝙿𝚒𝚛𝚊𝚌𝚢 𝚒𝚜 𝚌𝚛𝚒𝚖𝚎 𝙳𝚘 𝚗𝚘𝚝 𝚊𝚜𝚔 18+')
        ...
        buttons = [[
            InlineKeyboardButton('𝚄𝚙𝚍𝚊𝚝𝚎𝚜', url='https://t.me/+u-ldGW74d5JiYjE1')
        ], [
            InlineKeyboardButton('𝙷𝚘𝚖𝚎', callback_data='start'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝙵𝚘𝚛𝚖𝚊𝚝𝚎', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('𝙱𝚊𝚌𝚔', callback_data='manuelfilter')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('𝙱𝚊𝚌𝚔', callback_data='help'),
            InlineKeyboardButton('𝙰𝚍𝚖𝚒𝚗', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('𝙱𝚊𝚌𝚔', callback_data='extra')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('𝙱𝚊𝚌𝚔', callback_data='help'),
            InlineKeyboardButton('𝚁𝚎𝚏𝚛𝚎𝚜𝚑', callback_data='rfrsh')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        await query.answer("𝙵𝚎𝚝𝚌𝚑𝚒𝚗𝚐 𝙳𝙱")
        buttons = [[
            InlineKeyboardButton('𝙱𝚊𝚌𝚔', callback_data='help'),
            InlineKeyboardButton('𝚁𝚎𝚏𝚛𝚎𝚜𝚑', callback_data='rfrsh')
        ]]
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb and imdb.get('poster'):
        try:
            d = await message.reply_photo(photo=imdb.get('poster'), caption=cap[:1024],
                                      reply_markup=InlineKeyboardMarkup(btn))
            ...
            logger.exception(e)
            l = await message.reply_text(cap, reply_markup=InlineKeyboardMarkup(btn))
            await asyncio.sleep(300)
            await l.delete()
            await message.delete()
    else:
            ...
            if btn is not None:
                try:
                    if fileid == "None":
                        ...
                        button = eval(btn)
                        b = await message.reply_cached_media(
                            fileid,
                            caption=reply_text or "",
                            reply_markup=InlineKeyboardMarkup(button),
                            reply_to_message_id=reply_id
