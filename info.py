...
API_ID = int(environ.get('API_ID', '25019472'))
API_HASH = environ.get('API_HASH', '210d42e7863e4328859cb472c9f4751e')
BOT_TOKEN = environ.get('BOT_TOKEN', '6515421323:AAFHOY-i1FKXrYR2Mjr3gmOgpBRLWU_p9Rw')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '894474870 5343462550').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5343462550').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '1001833286468')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", CAP_TXT)
